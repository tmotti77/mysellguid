...
export class SeedService {
  ...
  private async createStores(users: User[]): Promise<Store[]> {
    ...
    // Spread stores across Tel Aviv / Gush Dan area for better map testing
    const storesData = [
      {
      ...
      },
      {
        ...
        city: 'Tel Aviv',
        country: 'Israel',
        latitude: 32.0636,  // Tel Aviv South (~2.5km from center)
        longitude: 34.7728,
      ...
      },
      {
        ...
        address: 'Bialik Street 25',
        city: 'Ramat Gan',
        country: 'Israel',
        latitude: 32.0833,  // Ramat Gan (~1.5km from TLV center)
        longitude: 34.8167,
      ...
      },
      {
        ...
        address: 'HaYarkon Street 180',
        city: 'Tel Aviv',
        country: 'Israel',
        latitude: 32.0950,  // Tel Aviv North (Beach area, ~1.5km north)
        longitude: 34.7750,
      ...
      },
      {
        ...
        address: 'Allenby Street 75',
        city: 'Tel Aviv',
        country: 'Israel',
        latitude: 32.0700,  // Tel Aviv (Carmel Market area, ~1.7km south)
        longitude: 34.7700,
